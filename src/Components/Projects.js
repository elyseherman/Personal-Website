    ...
    render() {
        return (
            <div className='projects'>
                <ProjectsInProgressCard projectTitle='Rezist · Table Booking Agent' description='A program that books those hard-to-get reservations for you. Given a restaruant, a date, a time, and a party number, you can secure a booking at your favourite restaurant upon its release.' tag1={null} tag2={null} tag3={null} tag4={null} />
